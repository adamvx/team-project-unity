...
namespace Draco
{
    ...
    unsafe internal class DracoNative
    {
        ...
        unsafe static extern void ReleaseDracoMesh(
            DracoMesh** mesh);
        ...
        [DllImport(DRACODEC_UNITY_LIB)]
        unsafe static extern void ReleaseDracoData(
            DracoData** data);
        ...
        [DllImport(DRACODEC_UNITY_LIB)]
        unsafe static extern int DecodeDracoMeshStep1(
            byte* buffer, int length, DracoMesh** mesh, void** decoder, void** decoderBuffer);

        // Decodes compressed Draco::Mesh in buffer to mesh. On input, mesh
        // must be null. The returned mesh must released with ReleaseDracoMesh.
        [DllImport(DRACODEC_UNITY_LIB)]
        unsafe static extern int DecodeDracoMeshStep2(
        ...
        [DllImport(DRACODEC_UNITY_LIB)]
        unsafe static extern bool GetAttribute(
        ...
        [DllImport(DRACODEC_UNITY_LIB)]
        unsafe static extern bool GetAttributeByType(
